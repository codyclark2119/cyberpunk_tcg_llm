...
import { fightReplay, gigStealReplay } from "../tests/combat-resolution-replay";
for (const [name, replay] of [["fight-replay", fightReplay()], ["gig-steal-replay", gigStealReplay()]] as const) {
