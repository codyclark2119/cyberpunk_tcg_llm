...
import { yorinobuReplay } from "../tests/yorinobu-replay";
const r = yorinobuReplay();
writeFileSync(new URL("../tests/fixtures/yorinobu-replay.v1.json", import.meta.url), JSON.stringify(r, null, 2) + "\n");
