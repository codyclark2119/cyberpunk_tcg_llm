...
import { vDyingNightReplay } from "../tests/field-legends-replay";
const r = vDyingNightReplay();
writeFileSync(new URL("../tests/fixtures/field-legends-replay.v1.json", import.meta.url), JSON.stringify(r, null, 2) + "\n");
