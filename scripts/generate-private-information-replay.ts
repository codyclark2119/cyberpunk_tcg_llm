...
import { kiroshiReplay } from "../tests/private-information-replay";
const replay = kiroshiReplay();
writeFileSync(new URL("../tests/fixtures/kiroshi-replay.v1.json", import.meta.url), JSON.stringify(replay, null, 2) + "\n");
