...
export function supportsRestrictedPlay(card: DeepReadonly<CardRevisionSnapshot> | undefined, context: EngineContext) {
    ...
    return failure("UNSUPPORTED_RESTRICTION_CARD", "Only reviewed vanilla, cannot-attack Blocker, conditional unblockability and next-fight prevention shapes are supported");
}
