...
export const CardRevisionSnapshotSchema = LegacyCardSchema.extend({
    ...
    execution: z.strictObject({ scope: z.enum(["NONCOMBAT_SLICE_V1", "NONCOMBAT_PLAY_V1", "COMBAT_ATTACK_V1", "COMBAT_REACT_V1", "COMBAT_RESTRICTIONS_V1", "COMBAT_TRIGGERS_V1", "GEAR_CAPABILITIES_V1", "GEAR_PRIVATE_LOOK_V1", "ATTACK_ORDERED_EFFECTS_V1", "END_TURN_HISTORY_V1", "GEAR_DELAYED_ATTACK_V1", "FIELD_LEGENDS_V1", "FIRST_ATTACK_HISTORY_V1", "ATTACKING_AURA_V1", "ATTACK_PREVENTION_V1", "VALUE_CONDITIONS_V1", "ATTACK_CONDITION_POWER_V1", "TARGETED_SPEND_V1", "TARGETED_DEFEAT_V1"]), status: z.enum(["SUPPORTED", "UNSUPPORTED"]) }).optional(),
